...
try:
    ...
    HAS_SEARCH_PARSER = True
except ImportError:
    HAS_SEARCH_PARSER = False

from SHUKLAMUSIC import app
from pyrogram import filters


if HAS_SEARCH_PARSER:
...
async def search_(app: app, msg: Message):
    if not HAS_SEARCH_PARSER:
        return await msg.reply_text("**sᴇᴀʀᴄʜ ᴇɴɢɪɴᴇ ᴘᴀʀsᴇʀ ɪs ɴᴏᴛ ɪɴsᴛᴀʟʟᴇᴅ ᴏɴ ᴛʜɪs sʏsᴛᴇᴍ.**")
