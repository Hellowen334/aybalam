...
# Helper to clean/parse IDs safely
def clean_id(val, default=0):
    if not val:
        return default
...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "EmirAydin")
...
LOGGER_ID = clean_id(getenv("LOGGER_ID", "@aybalammusic"))
OWNER_ID = clean_id(getenv("OWNER_ID", "8280910288"))
...
# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/aryaduyuru")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/aryaduyuru")
...
LOG_GROUP_ID = clean_id(getenv("LOG_GROUP_ID", getenv("LOGGER_ID", "@aybalammusic")))
